...
[System.Serializable]
public class Part{
	// These three feilds need to be defined in the Inspector pane
...
public class Enemy_4 : Enemy {
	...
	void InitMovement() {
		...
		// Note to self: In the book it's MinRad, but shouldn't it be MaxRad?
	...
	// These parts return true if the Part has been destroyed
	...
	// These changes the color of just one Part to red instead of the whole ship.
	...
	void OnCollisionEnter(Collision coll) {
		...
		case "ProjectileHero":
			...
			// Check whether the part is still protected
			...
			Destroy (other); // Destroy this ProjectileHero
			break;
		}
	}
}
